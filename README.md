...
The `cgspatial-notebook` includes frequently used spatial libraries along with libraries that offer functions over climatic data.Also
contains Python, R, and Julia and is built on top of the datascience-notebook.
